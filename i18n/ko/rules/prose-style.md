...
"실제 너비 제한"은 *파일*의 속성이다 — 포매터나 린터가 강제하는 컬럼 규약, 또는 정말로 고정폭인 매체. 보는 사람의 화면이나 터미널 폭은 너비 제한이 **아니다**: 그건 내용에 대한 제약이 아니라 독자의 창일 뿐이고, 독자마다 다르다. 지금 내 디스플레이가 얼마나 넓은지에 맞춰 줄을 끊지 마라 — 파일의 내용은 네 뷰포트에 따라 달라지지 않는다.
