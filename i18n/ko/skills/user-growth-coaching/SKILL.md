...
description: "반복된 모호한 요청, 처음에 빠진 맥락, 해결책부터 콕 집은 X-Y 요청, 또는 직접 확인 가능한 검증이 시간을 크게 잡아먹은 문제를 푼 뒤, 사용자를 더 효과적인 요청으로 코칭할지 판단할 때 적용. 언제 코칭하고 언제 하지 말지, 3문장 이내의 보여주기 형식, 모호→구체 / 해결책→문제 / 맥락 누락 / 검증 공백 패턴을 다룬다. 사용자가 급하거나 짜증난 상태면 트리거하지 말 것."
---
