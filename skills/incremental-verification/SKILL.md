...
Step 3: node -e "insert one row into the database" → verify row in DB
Step 4: node -e "step 1 + 2 + 3 together for 1 item" → verify end-to-end
Step 5: Write script using verified code → run on 5 items → check DB
