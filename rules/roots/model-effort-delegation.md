...
- If Codex CLI is available, see `codex/codex-delegation.md` for cross-provider rules (three-turn cap, adversarial review via `/review`, capability routing, plan-stage review).
