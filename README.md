...
| File | Description |
|------|-------------|
| `rules/prose-style.md` | Plain spoken-rhythm language (no noun-stacks, no translationese, verbs over nominalizations), line breaks that fall at meaning boundaries, not the column limit, and sources attached where the claim is made rather than bunched in a trailing references block |
